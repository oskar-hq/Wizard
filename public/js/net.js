 ...
 *
 * Der Socket läuft über denselben Host und Port wie die Seite (`/ws`) –
 * damit funktioniert der Cloudflare Tunnel ohne Extrakonfiguration.
 */
...
export class Net extends EventTarget {
  constructor() {
    ...
    /** Wird vor jedem (Wieder-)Verbinden gefragt: liefert eine Reconnect-Nachricht. */
    this.resume = null;
  }
  ...
  /** Bequemer Listener: `net.on('game_state', msg => …)`. */
  on(type, handler) {
